    ...
    private void parseResult() {
        ...
        try {
            ...
            for (int i = 0; i < AdminArrays.length(); i++) {
                ...
                ActiveBookingsData data = new ActiveBookingsData(object.getString("bookingdate"),
                        object.getString("image"), object.getString("address"), object.getString("postcode"),
                        object.getDouble("price"), object.getString("starttime"), object.getString("endtime"),
